 ...
 * Google Apps Script Web App Backend (서버리스 무료 데이터베이스)
 * ============================================================
 * 
 * 🚀 배포 방법 (3분 완성):
 * 1. 구글 스프레드시트 (sheets.new) 생성
 * 2. 상단 메뉴 > [확장 프로그램] > [Apps Script] 클릭
 * 3. 이 파일(Code.gs)의 전체 코드를 복사하여 붙여넣고 저장 (Ctrl+S)
 * 4. 우측 상단 [배포] > [새 배포] 클릭
 * 5. 설정:
 *    - 유형(톱니바퀴): [웹 앱] (Web App)
 *    - 설명: 경비 정산 백엔드 v1
 ...
 * 7. 배포된 웹사이트의 [GAS 연동] 창에 붙여넣으면 DB 연결 완료!
 */
